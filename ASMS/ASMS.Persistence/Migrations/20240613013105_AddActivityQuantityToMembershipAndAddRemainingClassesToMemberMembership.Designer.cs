...
namespace ASMS.Persistence.Migrations
{
    ...
    [Migration("20240613013105_AddActivityQuantityToMembershipAndAddRemainingClassesToMemberMembership")]
    partial class AddActivityQuantityToMembershipAndAddRemainingClassesToMemberMembership
    {
            ...
            modelBuilder.Entity("ASMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(4894),
                            Description = "Super usuario con acceso a todos los modulos del sistema",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(4896)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5004),
                            Description = "Manager de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Manager",
                            UpdatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5004)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5007),
                            Description = "Miembro administrativo de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "StaffMember",
                            UpdatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5007)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5010),
                            Description = "Profesor de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Coach",
                            UpdatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5010)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5012),
                            Description = "Miembro/Cliente de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Member",
                            UpdatedAt = new DateTime(2024, 6, 13, 1, 31, 5, 388, DateTimeKind.Utc).AddTicks(5012)
                        });
                });
