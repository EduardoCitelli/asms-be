...
namespace ASMS.Persistence.Migrations
{
    ...
    [Migration("20240902231738_UpdateInstituteMemberClassBlockRelationShip")]
    partial class UpdateInstituteMemberClassBlockRelationShip
    {
            ...
            modelBuilder.Entity("ASMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8847),
                            Description = "Super usuario con acceso a todos los modulos del sistema",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8848)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8944),
                            Description = "Manager de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Manager",
                            UpdatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8945)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8992),
                            Description = "Miembro administrativo de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "StaffMember",
                            UpdatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8992)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8995),
                            Description = "Profesor de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Coach",
                            UpdatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8996)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8998),
                            Description = "Miembro/Cliente de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Member",
                            UpdatedAt = new DateTime(2024, 9, 2, 23, 17, 38, 184, DateTimeKind.Utc).AddTicks(8999)
                        });
                });
