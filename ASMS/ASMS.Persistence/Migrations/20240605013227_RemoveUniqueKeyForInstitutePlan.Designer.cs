...
namespace ASMS.Persistence.Migrations
{
    ...
    [Migration("20240605013227_RemoveUniqueKeyForInstitutePlan")]
    partial class RemoveUniqueKeyForInstitutePlan
    {
            ...
            modelBuilder.Entity("ASMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3823),
                            Description = "Super usuario con acceso a todos los modulos del sistema",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3825)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3919),
                            Description = "Manager de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Manager",
                            UpdatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3920)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3922),
                            Description = "Miembro administrativo de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "StaffMember",
                            UpdatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3923)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3925),
                            Description = "Profesor de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Coach",
                            UpdatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3925)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3928),
                            Description = "Miembro/Cliente de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Member",
                            UpdatedAt = new DateTime(2024, 6, 5, 1, 32, 26, 856, DateTimeKind.Utc).AddTicks(3928)
                        });
                });
