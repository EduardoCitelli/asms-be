...
namespace ASMS.Persistence.Migrations
{
    ...
    [Migration("20221102183453_AddedBusinessEntities")]
            ...
            modelBuilder.Entity("ASMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1866),
                            Description = "Super usuario con acceso a todos los modulos del sistema",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1868)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1957),
                            Description = "Manager de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Manager",
                            UpdatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1958)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1961),
                            Description = "Miembro administrativo de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "StaffMember",
                            UpdatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1961)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1963),
                            Description = "Profesor de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Coach",
                            UpdatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1963)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1965),
                            Description = "Miembro/Cliente de la institución",
                            IsDelete = false,
                            LastEditedBy = "admin",
                            Name = "Member",
                            UpdatedAt = new DateTime(2022, 11, 2, 18, 34, 53, 269, DateTimeKind.Utc).AddTicks(1966)
                        });
                });
